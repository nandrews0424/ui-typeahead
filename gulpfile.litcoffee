Build ui-typeahead from source into
build/ui-typeahead.html, all streamlined and ready to be included.
...
Vulcanize for the speed.
    ...
    gulp.task 'vulcanize', ['elements'], ->
      built = 'build/ui-typeahead.html'
      gulp.src ''
        .pipe shell([
          "vulcanize --inline --strip -o ui-typeahead.html #{__dirname}/build/*.html"
          ])
